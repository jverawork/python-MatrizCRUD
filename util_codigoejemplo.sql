   ...
   INSERT INTO AUD_EXPEDIENTES_T@DBK_AUDIMED_DBREPLICA
    ...
    ID_TRAMITE,
    VAL_IESS
        FROM IESS.AUD_EXPEDIENTES_T T3, TABLA31 T31, TABLA326@db1.com T32, PQ.Tabla33
...
/*
   INSERT INTO AUD_SERVICIOS_T@DBK_AUDIMED_DBREPLICA
    ...
    DIAGNOSTICO_5
        ...
        WHERE NOT EXISTS (SELECT 'X' FROM AUD_SERVICIOS_T@DBK_AUDIMED_DBREPLICA X6 WHERE X.ID_SERVICIO = S5.ID_SERVICIO);
